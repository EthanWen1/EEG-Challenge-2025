...
4. **Install Dependencies**  
   ...
   ```
   *Note*: You will also need to manually install PyTorch. Please follow the instructions on the [official PyTorch website](https://pytorch.org/get-started/locally/) to install the appropriate version for your system.
